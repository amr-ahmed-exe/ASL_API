...
def predict_from_skeleton(pts):
    ...
    # -----------------------------------------------------------------------
    # ASPECT RATIO FIX:
    # MediaPipe بيبعت نسب (0.0 → 1.0) مش بيكسلات حقيقية
    # لازم نضربها في أبعاد الشاشة عشان الإيد متنضغطش
    # -----------------------------------------------------------------------
    pts[:, 0] *= 720.0   # ضرب الـ X في متوسط عرض الشاشة
    pts[:, 1] *= 1280.0  # ضرب الـ Y في متوسط طول الشاشة
